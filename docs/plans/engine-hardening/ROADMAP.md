...
| Step 13~16 (formula/parser/quality property + reproducibility 코드)     |   1.8d    |     2.5d     |    3.5d     | 🟡 진행 (Step 13 ✅ + Step 14a ✅ + Step 15a ✅ + Step 16a ✅ 2026-04-30, Step 14b 이연 = LLM 통합 후 / Step 15b 이연 = Engine Hardening 다음 세션 / Step 16b 이연 = e2e 시나리오 A/B/C/E / Step 16c 이연 = 0016 마이그레이션 e2e) |
