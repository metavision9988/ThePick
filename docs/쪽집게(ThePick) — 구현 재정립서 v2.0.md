...
> **v1.0 수정:** 11종 → 12종 (CROSS_REF 추가, 상법 보험편 준용 관계)
...
| BATCH 6 | 가축재해보험           | p.648~757 | P2         |
| BATCH 7 | 1권 전체 (이론/약관)   | p.1~388   | P2         |
...
> **v1.0에서 11개 → 14개로 확장** (v1.1 방어패치 3건 + 1차 전용 3건 반영)
...
8. Ontology Lock: ontology-registry.json 외 ID 거부 ← v1.1 패치
9. eval() 금지: math.js AST 파서로만 실행 ← v1.1 패치
10. Hairball 방지: Graph Visualizer 서브그래프 단위만 ← v1.1 패치
