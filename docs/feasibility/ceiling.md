...
| **Graph-walk multi-hop 정답률 기여** | **혼재 — 도메인·데이터 의존, 이득 비보장** | **🔻 (1·2·3차 실측 — 순기여 0 3연속 → R5 NO-GO 2026-07-14)** | R3 1차(06-01) + 2차(06-05 queryBody 정화 N=6) + 3차(07-07 golden v2 N=19): depth1 순손실 전환(Δ−5.3%)·depth2 Δ−15.8%·graphOnlyRecovery 0 3연속. **진산 R5(07-14) = 현 설계 NO-GO·동결 + D안(lexical fusion) 경로** — 재상신 = D안 비교 측정(#8). 기록 `thepick.feasibility.md` R5 |
